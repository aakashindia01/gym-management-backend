...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    tenantRef = models.ForeignKey('tenants.Tenant', on_delete=models.CASCADE, related_name="users", default=None, null=True, blank=True)
    tenantId = models.CharField(max_length=36, blank=True, null=True)
